...
def upgrade() -> None:
    ...
    op.bulk_insert(
        tasks,
        [
            {"title": "task 1", "description": "description of task 1", "status": "Pending", "deleted": False, "due_date": None, "owner_id": 1},
            {"title": "task 2", "description": "description of task 2", "status": "Pending", "deleted": False, "due_date": None, "owner_id": 2},
            {"title": "task 3", "description": "description of task 3", "status": "Pending", "deleted": False, "due_date": None, "owner_id": 1},
            {"title": "task 4", "description": "description of task 4", "status": "Pending", "deleted": False, "due_date": None, "owner_id": 2},
            {"title": "task 5", "description": "description of task 5", "status": "Pending", "deleted": False, "due_date": None, "owner_id": 1},
            {"title": "task 6", "description": "description of task 6", "status": "Pending", "deleted": False, "due_date": None, "owner_id": 3}
        ]
    )
